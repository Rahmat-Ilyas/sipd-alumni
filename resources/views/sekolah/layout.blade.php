            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('sekolah/home') }}" class="nav-link" id="nav-home">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('sekolah/input-alumni') }}" class="nav-link" id="nav-input-alumni">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('sekolah/data-alumni') }}" class="nav-link" id="nav-data-alumni">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('sekolah/profil-sekolah') }}" class="nav-link"
                                id="nav-profil-sekolah">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('sekolah/logout') }}" class="nav-link">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 20px 50px 0 50px">
                    ...
                    <form method="POST" action="{{ url('sekolah/update/akun') }}" id="edit-akun" hidden="">
                        @csrf
